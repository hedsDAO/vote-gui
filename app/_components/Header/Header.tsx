  ...
  return (
    <Flex {...styles.$headerFlexContainer}>
      <Flex {...styles.$typographyAndBadgeFlexContainer}>
        <Typography {...styles.$typographyStyles}>{constants.HEADER_ONE_TEXT}</Typography>
      ...
      <Flex {...styles.$typographyAndAvatarFlexContainer}>
        ...
        <Typography {...styles.$typographyStyles}>{constants.HEADER_TWO_TEXT}</Typography>
      </Flex>
      <Flex {...styles.$descriptionFlexStyles}>
        <Typography {...styles.$descriptionTypographyStyles}>{constants.DESCRIPTION_TEXT}</Typography>
      </Flex>
    </Flex>
  );
};
