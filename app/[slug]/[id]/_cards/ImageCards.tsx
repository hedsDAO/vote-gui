    ...
    return (
      <>
        {sortedChoicesWithScores?.map((choice) => {
          return <ClosedImageCard key={choice.id} proposal={proposal} userVote={userVote} choice={choice} />;
        })}
      </>
    );
    ...
    return (
      <>
        {proposal?.choices?.map((choice) => {
          return <OpenImageCard key={choice.id} userVote={userVote} choice={choice} />;
        })}
      </>
    );
  }
