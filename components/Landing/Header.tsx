...
const Header = () => {
  return (
    <div className="flex w-[100vw] flex-col items-center justify-center gap-5 bg-heds-bg pb-12 pt-6 lg:gap-8 lg:pb-20 lg:pt-16">
      <div className="flex items-center gap-4 lg:gap-8">
        <h1 className="font-inter text-5xl font-bold text-white lg:text-7xl tracking-wide">
          VOTING FOR
        </h1>
      ...
      <div className="flex flex-col items-center gap-6 lg:flex-row lg:gap-8">
        ...
        <h1 className="font-inter text-5xl font-bold tracking-wide text-white lg:text-7xl">
          THE MASSES
        </h1>
      </div>
