...
const MediaCard = ({ title, image }: MediaCardProps) => {
  ...
  return (
    <div
      ...
      className="w-[43vw] h-40 rounded-xl border-[1px] border-fuchsia-200/30 bg-black/30 shadow-sm shadow-black/60 transition-all ease-in-out hover:bg-heds-bg-light lg:h-48 lg:w-52 "
    >
